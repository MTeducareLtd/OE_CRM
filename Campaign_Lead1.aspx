<%@ Page Title="" Language="C#" MasterPageFile="~/OE_CRM.master" AutoEventWireup="true" CodeFile="Campaign_Lead1.aspx.cs" Inherits="Campaign_Lead1" %>
...
<link rel="stylesheet" type="text/css" href="SIPassets/global/plugins/bootstrap-select/css/bootstrap-select.min.css?v=<%=Version%>" />    
    ...
    <script src="CustomJS/Campign_lead.js?v=<%=Version%>" type="text/javascript"></script>
