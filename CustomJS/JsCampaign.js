...
//    }
    ...
    $("#tdAvailableLeads").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtToRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 1;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });
    ...
    $("#tdAccount").click(function () {
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 3;
        document.getElementById("lblPageNo").value = 1;
        $('#TCampaign').html('');
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    ...
    $("#tdLostContacts").click(function () {
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 6;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });

    $("#tdTotalFollowupDoneTillDate").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 14;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });
    ...
    $("#tdYeasterdayPendingFollowup").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 8;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });

    $("#tdNextsevendayfollowup").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 9;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });

    $("#tdprevsevendaysfollowup").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 10;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });

    $("#tdLast50touchfollowup").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 11;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });

    $("#tdUnattemptedContacts").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        //        $("#ddlMTNMT").val('Select').change();
        ...
        //        document.getElementById("txtToRank").value = "";
        ClearAdvanceCampaignSearch();
        document.getElementById("lblCamapignflag").value = 12;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });

    $("#tdCalledbutnotConvertedtoLead").click(function () {
        waitingDialog.show('Please wait while the data is getting populated', { dialogSize: 'sm', progressType: 'warning' });
        ClearAdvanceCampaignSearch();
        //        document.getElementById("txtCampStudentName").value = "";
        //        //document.getElementById("txtCampSchoolName").value = "";
        ...
        //        document.getElementById("txtFromRank").value = "";
        //        document.getElementById("txtToRank").value = "";
        document.getElementById("lblCamapignflag").value = 13;
        document.getElementById("lblPageNo").value = 1;
        GetCampaignCountDetailsData();
        waitingDialog.hide();
    });
...
function CampaignEventTypeFill(objthis) {
    ...
    $.ajax({
        type: 'POST',
        url: "./WebMethods/WcCampaign.asmx/BindCampaignEvents_Type",
        dataType: "json",
...
function CampaignEventFeedbackHeader() {
    ...
    $.ajax({
        type: 'POST',
        url: "./WebMethods/WcCampaign.asmx/BindCampaignEvents_Header",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        data: '{"CampaignId":"' + CampaignId + '","EventId":"' + EventId + '"}',
        type: "POST",
...
function CampaignEventFeedbackValues() {
    ...
    $.ajax({
        type: 'POST',
        url: "./WebMethods/WcCampaign.asmx/BindCampaignEvents_Header_Values",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
...
//    document.getElementById('lblYesterdayFollowup').innerHTML = "";
    ...
    $.ajax({
        type: 'POST',
        url: "./WebMethods/WcCampaign.asmx/CampaignCountsDetail",
        contentType: "application/json; charset=utf-8",
        ...
        success: (function (data) {
            $(data.d).each(function (index, obj) {
                ...
                document.getElementById('lblAvailableLeads').innerHTML = obj.AvaibleLeads;
...
function ViewStudentData(concode) {   //To view Student Details On convert To Lead Click
    ...
    $.ajax({
        type: 'POST',
        url: "./WebMethods/WcCampaign.asmx/ViewContactDetail",
        contentType: "application/json; charset=utf-8",
        data: '{"ConId":"' + concode + '"}',
        dataType: "json",
        async: false,
...
function ViewMoreContactsDetail(concode) {   //To view More Contacts Details On More Contact Details Click
    //Getstudentdataforcalling(concode);
...
//    document.getElementById('lblcontact_ID').innerHTML = "";
//    document.getElementById('lblCapmingID').innerHTML = "";
    waitingDialog.show('Please wait...', { dialogSize: 'sm', progressType: 'warning' });
    $.ajax({
        type: 'POST',
        url: "./WebMethods/WcCampaign.asmx/ViewMoreContactDetails",
        contentType: "application/json; charset=utf-8",
        data: '{"ConId":"' + concode + '"}',
        dataType: "json",
        async: false,
...
//                document.getElementById('lblcontact_ID').innerHTML = obj.ContactID;
//                document.getElementById('lblCapmingID').innerHTML = obj.CampaingID;

                if (obj.Handphone1 != '') {
                    document.getElementById('lblStudentHandphone1').innerHTML = "" + obj.Handphone1 + "<a id='aStudentHandphone1' onclick='callStart(this);' data-attr='" + obj.Handphone1 + '%' + obj.ContactID + '%' + obj.CampaingID + "'><img src='Images/MobileCall.png' width='25px' /></a><a id='a1StudentHandphone2' onclick='callend(this);' data-attr='" + obj.Handphone2 + '%' + obj.ContactID + '%' + obj.CampaingID + "'></a>"; //Handphone1
                    //document.getElementById('lblStudentHandphone1').innerHTML = "" + obj.Handphone1 + ; //Handphone1
                }
                if (obj.Handphone2 != '') {
                    document.getElementById('lblStudentHandphone2').innerHTML = "" + obj.Handphone2 + "<a id='aStudentHandphone2' onclick='callStart(this);' data-attr='" + obj.Handphone2 + '%' + obj.ContactID + '%' + obj.CampaingID + "'><img src='Images/MobileCall.png' width='25px' /></a><a id='a2StudentHandphone2' onclick='callend(this);' data-attr='" + obj.Handphone2 + '%' + obj.ContactID + '%' + obj.CampaingID + "'></a>";
                }
                //document.getElementById('lblStudentHandphone2').innerHTML = obj.Handphone2;
                if (obj.FatherHandphone1 != '') {
                    document.getElementById('lblFatherHandphone1').innerHTML = "" + obj.FatherHandphone1 + "<a id='aFatherHandphone1' onclick='callStart(this);' data-attr='" + obj.FatherHandphone1 + '%' + obj.ContactID + '%' + obj.CampaingID + "'><img src='Images/MobileCall.png' width='25px' /></a><a id='a3StudentHandphone2' onclick='callend(this);' data-attr='" + obj.Handphone2 + '%' + obj.ContactID + '%' + obj.CampaingID + "'></a>";
                }
                //document.getElementById('lblFatherHandphone1').innerHTML = obj.FatherHandphone1;
                if (obj.FatherHandphone2 != '') {
                    document.getElementById('lblFatherHandphone2').innerHTML = "" + obj.FatherHandphone2 + "<a id='aFatherHandphone2' onclick='callStart(this);' data-attr='" + obj.FatherHandphone2 + '%' + obj.ContactID + '%' + obj.CampaingID + "'><img src='Images/MobileCall.png' width='25px' /></a><a id='a4StudentHandphone2' onclick='callend(this);' data-attr='" + obj.Handphone2 + '%' + obj.ContactID + '%' + obj.CampaingID + "'></a>";
                }
...
//added by sujeer for  calling--20082018
function callStart(id) {

    var s = $(id).attr('data-attr'); // code for split the string
    var fields = s.split("%");
    var phoneNumber = fields[0];
    var customerid = fields[1];
    var campaign_id = fields[2];

    //var phoneNumber = $(id).attr('data-attr');
...
//            alert(campaign_id);
        ...
        if (Chk == 'M') {
            AAndroid.getCallENDDetail(phoneNumber, agentId, customerid, campaign_id);
        }
