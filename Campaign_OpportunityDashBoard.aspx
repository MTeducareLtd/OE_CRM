<%@ Page Title="" Language="C#" MasterPageFile="~/OE_CRM.master" AutoEventWireup="true" CodeFile="Campaign_OpportunityDashBoard.aspx.cs" Inherits="Campaign_OpportunityDashBoard" %>
...
<link rel="stylesheet" type="text/css" href="SIPassets/global/plugins/bootstrap-select/css/bootstrap-select.min.css?v=<%=Version%>" />    
    ...
    <script src="CustomJS/Campaign_Opportunity_DashBorad.js?v=<%=Version%>" type="text/javascript"></script>
