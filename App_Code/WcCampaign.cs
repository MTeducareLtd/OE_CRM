...
/// <summary>
/// Summary description for WcCampaign
/// </summary>
[WebService(Namespace = "http://tempuri.org/")]
[WebServiceBinding(ConformsTo = WsiProfiles.BasicProfile1_1)]
// To allow this Web Service to be called from script, using ASP.NET AJAX, uncomment the following line. 
[System.Web.Script.Services.ScriptService]
public class WcCampaign : System.Web.Services.WebService {
            ...
            if (ds != null && ds.Tables.Count != 0)
            {
                foreach (DataRow drStudentDetails in ds.Tables[0].Rows)
                {
                    lstMoreContactDetail.Add(new
                    {
                        ...
                        ContactID = drStudentDetails["Con_Id"].ToString(),
                        CampaingID = drStudentDetails["Campaign_id"].ToString(),
                    });
                }
            }
