<%@ Page Title="" Language="C#" MasterPageFile="~/OE_CRM.master" AutoEventWireup="true" CodeFile="Campaign_TodayFallowup.aspx.cs" Inherits="Campaign_TodayFallowup" %>
...
<link rel="stylesheet" type="text/css" href="SIPassets/global/plugins/bootstrap-select/css/bootstrap-select.min.css?v=<%=Version%>" />    
    ...
    <%--<script type="text/javascript" src="CustomJS/Campaign_Lead.js?v=<%=Version%>"></script>--%>
   <%-- <script src="CustomJS/OverDue_Fallowup_DashBorad.js?v=<%=Version%>" type="text/javascript"></script>--%>
     <script src="CustomJS/Campaign_TodayFallowup.js?v=<%=Version%>" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        function ReadConfigSettings() {
            ...
            document.getElementById("lblCampaignDetailcode").value = "";
        }
    </script>
    <style type="text/css">
        .errorClass
